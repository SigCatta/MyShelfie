...
public class PrinterTest {
    @Test
    public void printColorMatrixTest() {
        ItemTile[][] matrix1 = {
        ...
        Printer.printColorMatrix(matrix1);

        System.out.println();

        ItemTile[][] matrix2 = {
                {new ItemTile(Color.LIGHTBLUE), new ItemTile(Color.PINK), new ItemTile(Color.BLUE), new ItemTile(Color.WHITE), new ItemTile(Color.WHITE), new ItemTile(Color.PINK)},
                {null, new ItemTile(Color.GREEN), new ItemTile(Color.BLUE), new ItemTile(Color.WHITE), new ItemTile(Color.WHITE), new ItemTile(Color.PINK)},
        ...
        Printer.printColorMatrix(matrix2);
    }
}
